...
Patch1: 0002-daemon-Support-stateless-operating-systems-with-spli.patch
...
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dsystemdsystemunitdir=/usr/lib/systemd/system \
-Dgtk_doc=true \
-Dadmin_group=wheel  builddir
ninja -v -C builddir
CFLAGS="$CFLAGS -m64 -march=x86-64-v3 -Wl,-z,x86-64-v3 -O3" CXXFLAGS="$CXXFLAGS -m64 -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -m64 -march=x86-64-v3" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dsystemdsystemunitdir=/usr/lib/systemd/system \
-Dgtk_doc=true \
-Dadmin_group=wheel  builddiravx2
...
cp %{_builddir}/accountsservice-%{version}/COPYING %{buildroot}/usr/share/package-licenses/accountsservice/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
...
%files libexec
%defattr(-,root,root,-)
/V3/usr/libexec/accounts-daemon
