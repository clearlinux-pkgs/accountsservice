...
Source0  : https://www.freedesktop.org/software/accountsservice/accountsservice-0.6.46.tar.xz
...
%prep
%setup -q -n accountsservice-0.6.46
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1523016654
